...
async def test_cli_db_ping_success():
    ...
    with patch('final_project.src.hackathon_assistant.infra.cli.get_settings',
               return_value=mock_settings):
        with patch('final_project.src.hackathon_assistant.infra.cli.db_ping',
            ...
            with patch('builtins.print') as mock_print:
                ...
                mock_print.assert_has_calls([
                    call(f"DATABASE_URL={mock_settings.database_url}"),
                    call('DB ping OK')
                ])
...
async def test_create_hackathon_success():
    ...
    try:
        ...
        with patch('final_project.src.hackathon_assistant.infra.cli.get_session') as mock_session:
            with patch('final_project.src.hackathon_assistant.infra.cli.RepositoryProvider') as mock_repo:
                # Настраиваем моки
                ...
                with patch('builtins.print') as mock_print:
                    ...
                    mock_print.assert_called_with('Created hackathon id=1 code=\'TEST2025\' name=\'Test Hackathon\'')
    finally:
