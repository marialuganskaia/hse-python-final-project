...
class TestSelectHackathonByCodeUseCase:
    ...
    @pytest.mark.asyncio
    async def test_execute_success(self, mock_user_repo, mock_hackathon_repo,
                                   sample_user, sample_hackathon):
    ...
    @pytest.mark.asyncio
    async def test_execute_user_not_found(self, mock_user_repo, mock_hackathon_repo, sample_hackathon):
        ...
        mock_user_repo.get_by_telegram_id.assert_c